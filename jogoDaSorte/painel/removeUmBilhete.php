...
<body>
    ...
    <div class="container">
                ...
                <ul id="list">
                    <li>
                        ...
                        <li><a href="adicionarBilhete.php">Adicionar Bilhete</a></li>
                            ...
                            <li style="background-color: #2c3e50;"><a href="removeUmBilhete.php">Remover Bilhete</a></li>
                        </ul>
                    </li>
                    <li>
        ...
        <div class="sidebarDireira">
            <p>Remova um único bilhete com o id</p>
            <form method="POST">
                <input type="Nome" name="id_apagar" placeholder="Id do jogo">
                <input type="submit" value="Apagar esse bilhete" name="deleterUmBilhete">
            </form>
            <?php
            $c->deletarUmJogo();
            ?>
