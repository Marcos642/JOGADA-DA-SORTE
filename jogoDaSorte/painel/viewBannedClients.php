...
<body>
    ...
    <div class="container">
                ...
                <ul id="list">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li style="background-color: #2c3e50;"><a href="viewBannedClients.php">Ver todos os clientes banidos</a></li>
                        </ul>
                    </li>
                    <li>
        ...
        <h2>Todos os Clientes banidos</h2>
        <?php
            $sql = "SELECT id_usuario, nome, telefone, email, data_deletado FROM usuarios_log";
            $row = $pdo->query($sql);
            ...
            foreach ($row as $thiss) {
                ...
                echo '<p>Quando: ' . $thiss['data_deletado'] . '</p>';
                echo '</div>';
            }
            ?>
        </div>
