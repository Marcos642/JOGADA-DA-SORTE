...
<body>
    <div class="container">
                ...
                <ul id="list">
                    <li>
                        ...
                        <li><a href="adicionarBilhete.php">Adicionar Bilhete</a></li>
                            <li style="background-color: #2c3e50;"><a href="removeJogo.php">Remover modalidade de Jogo</a></li>
        ...
        <div class="sidebarDireira">
            <p>Remova todos os jogos de uma modalidade qualquer</p>
            <form method="POST">
                <input type="Nome" name="jogoAPAGAR" placeholder="Nome do jogo">
                <input type="submit" value="Apagar todos os jogos" name="deleterJogo">
            </form>
            <?php
            $c->deletarModalidade();
            ?>
